...
// Demo functions
async function demoHealthCheck(): Promise<void> {
    console.log('🏥 Health Check:');
    try {
        const response: AxiosResponse = await axios.get(`${SERVER_URL}/health`);
...
async function demoToolsList(): Promise<void> {
    console.log('🔧 Available Tools:');
    try {
        const response: AxiosResponse = await axios.get(`${SERVER_URL}/mcp/tools`);
...
async function demoHttpPost(): Promise<void> {
    console.log('🌐 HTTP POST Tool Demo:');
    console.log('   📤 Sending POST request to httpbin.org...');
    
    try {
        const response: AxiosResponse = await axios.post(`${SERVER_URL}/mcp/call-tool`, {
            tool: 'http_post',
            parameters: {
...
async function demoWeatherTool(): Promise<void> {
    console.log('🌤️  Weather Tool Demo:');
    console.log('   🎲 Getting mock weather data...');
    
    try {
        const cities: string[] = ['Tokyo', 'London', 'New York', 'Sydney', 'Paris'];
...
async function demoCreatePost(): Promise<void> {
...
async function demoSSEConnection(): Promise<void> {
